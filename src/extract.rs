...
const PATH_EXTS: &[&str] = &[
    "py", "pyi", "pyx", "rs", "js", "mjs", "cjs", "jsx", "ts", "tsx", "go", "java", "kt", "rb",
    "c", "h", "cc", "cpp", "cxx", "hpp", "cs", "php", "swift", "scala", "clj", "ex", "exs", "erl",
    "hs", "ml", "fs", "dart", "lua", "pl", "pm", "r", "jl", "nim", "zig", "md", "markdown", "rst",
    "adoc", "txt", "toml", "yaml", "yml", "json", "json5", "jsonc", "cfg", "ini", "conf", "lock",
    "sh", "bash", "zsh", "fish", "ps1", "bat", "cmd", "html", "htm", "css", "scss", "sass", "less",
    "sql", "xml", "csv", "tsv", "proto", "graphql", "gql", "vue", "svelte", "mk", "gradle",
    "properties", "dot", "gv", "ipynb", "tf", "hcl", "env", "rake", "gemspec", "podspec",
];
